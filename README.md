...
The card will be inserted into a protective 35pt Toploader, and inserted into the base shell, and then held in place by the top lid, which is screwed i to the base via screws. The case has many different paths and spaces for the different parts. The LEDs have a rectangular cutout around the card, with small holes in the wall separating them to make a underglow effect, but will be facing upwards, into 3D printed diffusers. The case has a second rectangular hole surrounding the leds, I’m planning in putting all the battery and led wires in them (the battery is above the leds, and therefore the leds are in between the battery and xiao).The wire paths will have an occasional hole in the intersecting wall to provide holes for wires to come through.
